...
const generateInvite = (base64, file_name) => {
    let qr_inv = qr.image(base64, { type: 'png', margin: 4 });
    qr_inv.pipe(require('fs').createWriteStream(`./mediaSend/${file_name}`));
    console.log(`⚡ Generando invitacion para: ${file_name} ⚡'`);
}
...
const isValidNumber = (rawNumber) => {
    ...
    //const blocked = !rawNumber.match("+59172209801");
    return !exist //|| !blocked
}

module.exports = {cleanNumber, saveExternalFile, generateImage, generateInvite, checkIsUrl, checkEnvFile, createClient, isValidNumber}